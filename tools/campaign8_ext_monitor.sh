#!/usr/bin/env bash
#
# Campaign 8 extension monitor — status, crashes, stats for campaign8_ext run.
#

ROOT="$(cd "$(dirname "$0")/.." && pwd)"
CAMPAIGN_DIR="$ROOT/logs/fuzz-findings/campaign8_ext"

echo "=== Campaign 8 Extension Status @ $(date '+%Y-%m-%d %H:%M:%S') ==="
echo ""
