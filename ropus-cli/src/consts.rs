...
pub(crate) const OPUS_SR: u32 = 48_000;
/// 20 ms frame at 48 kHz = 960 samples per channel.
pub(crate) const FRAME_SAMPLES_PER_CH: usize = 960;
/// Maximum bytes for a single Opus frame, per RFC 6716 §3.2.1.
pub(crate) const MAX_OPUS_FRAME_BYTES: usize = 1275;
...
pub(crate) const FRAMES_PER_PACKET: usize = 1;
/// Maximum Opus packet bytes for our config: `MAX_OPUS_FRAME_BYTES * FRAMES_PER_PACKET`.
pub(crate) const MAX_PACKET_BYTES: usize = MAX_OPUS_FRAME_BYTES * FRAMES_PER_PACKET;
